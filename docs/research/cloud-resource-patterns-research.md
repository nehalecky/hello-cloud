...
Web applications exhibit distinct temporal patterns based on their usage characteristics [^5]. For detailed implementation examples, see the [Workload Signatures Guide](../notebooks/02_guide_workload_signatures_guide.ipynb) notebook.
...
[^1]: Data Center Dynamics. (2024). ["Study: Only 13% of provisioned CPUs and 20% of memory utilized in cloud computing."](https://www.datacenterdynamics.com/en/news/only-13-of-provisioned-cpus-and-20-of-memory-utilized-in-cloud-computing-report/) *DCD*.
[^2]: CloudZero. (2025). ["90+ Cloud Computing Statistics: A 2025 Market Snapshot."](https://www.cloudzero.com/blog/cloud-computing-statistics/) *CloudZero Blog*.
[^3]: Harness. (2025). ["$44.5 Billion in Infrastructure Cloud Waste Projected for 2025."](https://www.prnewswire.com/news-releases/44-5-billion-in-infrastructure-cloud-waste-projected-for-2025-due-to-finops-and-developer-disconnect-finds-finops-in-focus-report-from-harness-302385580.html) *PR Newswire*.
[^4]: ProsperOps. (2024). ["How To Identify and Reduce Cloud Waste."](https://www.prosperops.com/blog/how-to-identify-and-prevent-cloud-waste/) *ProsperOps Blog*.
[^5]: Aqua Security. (2024). ["Cloud Workloads: Types, Common Tasks & Security Best Practices."](https://www.aquasec.com/cloud-native-academy/cspm/cloud-workload/) *Aqua Cloud Native Academy*.
[^6]: Alluxio. (2024). ["GPU Utilization: What Is It and How to Maximize It."](https://www.alluxio.io/blog/maximize-gpu-utilization-for-model-training) *Alluxio Blog*.
[^7]: Microsoft Research. (2024). ["An Empirical Study on Low GPU Utilization of Deep Learning Jobs."](https://www.microsoft.com/en-us/research/publication/an-empirical-study-on-low-gpu-utilization-of-deep-learning-jobs/) *ICSE 2024 Proceedings*.
[^8]: Alluxio. (2024). ["MLPerf Storage v2.0 Results Showing 99%+ GPU Utilization."](https://www.alluxio.io/blog/maximize-gpu-utilization-for-model-training) *Alluxio Performance Benchmarks*.
[^9]: AWS. (2024). ["View CPU and memory usage for Aurora MySQL-Compatible DB clusters."](https://repost.aws/knowledge-center/rds-aurora-mysql-view-cpu-memory) *AWS Knowledge Center*.
[^10]: Microsoft Azure. (2024). ["Advancing memory leak detection with AIOps—introducing RESIN."](https://azure.microsoft.com/en-us/blog/advancing-memory-leak-detection-with-aiops-introducing-resin/) *Azure Blog*.
[^11]: AST Consulting. (2024). ["Zombie Resources in the Cloud: What They Are and How to Banish Them."](https://astconsulting.in/finops/zombie-resources-in-the-cloud) *AST Consulting FinOps*.
[^12]: FinOps Foundation. (2024). ["Resource Utilization & Efficiency Framework Capability."](https://www.finops.org/framework/capabilities/utilization-efficiency/) *FinOps.org*.
[^13]: Williams, D. (2024). ["FinOps is Stuck — Cloud Waste is Out of Control; But There's a Fix."](https://medium.com/@dpwilliams03/finops-is-stuck-cloud-waste-is-out-of-control-but-theres-a-fix-c28e1155b86c) *Medium*.
