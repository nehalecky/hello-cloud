...
def configure_notebook_logging(level: str = "INFO", show_time: bool = False):
    ...
    Example:
        ```python
        from hellocloud.utils import configure_notebook_logging
...
def quiet_library_logging():
    ...
    Example:
        ```python
        from hellocloud.utils import quiet_library_logging
...
def verbose_library_logging():
    ...
    Example:
        ```python
        from hellocloud.utils import verbose_library_logging
