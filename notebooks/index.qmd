...
**PiedPiper Cost Data EDA** (local execution only)
Cloud billing event analysis on 122 days of production data. Requires local data files (not published due to data size). Demonstrates attribute analysis via information theory, grain discovery for time series forecasting, and entity persistence validation.
